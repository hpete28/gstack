...
End-to-end walkthrough: [howto-ios-testing-with-gstack.md](howto-ios-testing-with-gstack.md).
...
| `/freeze` | Apply a directory boundary; enforcement depends on the host. |
